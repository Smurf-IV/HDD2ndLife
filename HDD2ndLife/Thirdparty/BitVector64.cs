    ...
    public struct BitVector64
    {
        ...
        public long this[BitVector64.Section section]
        {
            ...
            set
            {
                ...
                long num = ((long)uint.MaxValue & (long)section.Mask) << section.Offset;
        ...
        private static Section CreateSectionHelper(int maxValue, int priorMask, int priorOffset)
        {
            ...
            int offset = (int)(priorOffset + (long)CountBitsSet(priorMask));
        ...
        {
            StringBuilder stringBuilder = new StringBuilder(0x2d);
