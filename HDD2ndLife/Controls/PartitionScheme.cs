...
namespace HDD2ndLife.Controls
{
    ...
    public partial class PartitionScheme : KryptonForm
    {
        ...
        {
            var res = KryptonMessageBox.Show(this,
                "This is going to really mess with your selected HDD.\r\nAre you Sure?",
                @"Destructive Operations about to start", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation,
            ...
            try
            {
                ...
                string diskNumber = deviceId.Split(new string[] { @"PHYSICALDRIVE" }, 2, StringSplitOptions.RemoveEmptyEntries)[1];
