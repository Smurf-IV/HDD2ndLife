...
namespace Elucidate.Shared
{
    ...
    public class TextOverProgressBar : Windows7ProgressBar
    {
        ...
        {
            using var backgroundPath = GetRoundedRect(rect, 2, 2);
        ...
        private void DrawBarHighlight(Graphics g, Rectangle rect)
        {
            ...
            using (var tp = GetRoundedRect(tr, 2, 2))
            {
                g.SetClip(tp);
            ...
            using (var bp = GetRoundedRect(br, 2, 2))
            {
                g.SetClip(bp);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (Style)
            {
                ...
                case ProgressBarStyle.Continuous:
                    ...
                    {
                        e.Graphics.FillRectangle(brush, 1, 1, (int)(rec.Width * ((double)Value / Maximum)) - 2, rec.Height - 2);
                    }
                    break;
            ...
            using var sf = new StringFormat(StringFormatFlags.LineLimit | StringFormatFlags.NoWrap | StringFormatFlags.NoClip)
            {
